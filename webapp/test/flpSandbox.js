		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product List",
									"targetURL": "#comlab2devproductslist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devproductslist-display": {
								"semanticObject": "comlab2devproductslist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.products.list",
									"url": sap.ui.require.toUrl("com/lab2dev/products/list")
								}
							}
						}
					}
